...
<div class="flex justify-center p-8 h-screen">
    <div class="w-full sm:w-2/3  p-8 rounded-lg justify-content shadow-md transition-all duration-300 ease-in-out whitespace-pre-wrap">
        <header class="header">
        ...
        <div class="flex-1 p-4">
            ...
            {#if $currentVenue.type == "restaurant"}
                <label class="label"> 
                    <span>Cuisine</span>
                    <select class="select" value={$currentVenue.cuisine}> <!-- TODO: fix options -->
